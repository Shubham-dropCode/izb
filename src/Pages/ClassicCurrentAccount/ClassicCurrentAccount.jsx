        ...
        <div className="container pt-4">
          <div className="text-center my-5">
            <h1 style={{ color: "#484848" }}>
              Our IZB Classic Current Account Benefits
            </h1>
      ...
      >
        <div className="container-fluid">
          <div className="sec-title text-center">
            <h2>IZB Classic Current A/C Required Documents</h2>
                  ...
                  <ul>
                    <li>
                      <p className="text-white lh-base">
                        ...
                        Certificate of registration (Ent) or Certification of
                        Incorporation (Co.)
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p className="text-white lh-base">
                        <AiFillCaretRight size={15} className="pe-1" />
                        Copy of Declaration of Consent to Act as Director
                        (Company)
                      </p>
                    </li>
                    <li>
                ...
                >
                  <ul>
                    ...
                    <li>
                      <p className="text-white lh-base">
                        <AiFillCaretRight size={15} className="pe-1" />
                        Copy of latest annual Returns to the Registrar of
                        Companies
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p className="text-white lh-base">
                        <AiFillCaretRight size={15} className="pe-1" />
                        Employment/Residential permit in case of Foreign
                        Nationals
                      </p>
                    </li>
                    <li>
