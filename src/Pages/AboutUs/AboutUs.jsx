...
const AboutUs = () => {
  ...
  return (
    <>
      <Breadcrumb Heading="About Us" img={BackgroundBrundcrumb} paths={path} />
      <BriefHistory
        heading="Brief History"
        content="Indo Zambia Bank was formed on 19th October, 1984 by the Government of the Republic of Zambia and the Government of India out of the desire to promote banking facilities to support the economic development of Zambia."
