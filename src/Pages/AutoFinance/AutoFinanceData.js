export const question = [
  {
    id: 1,
    question: "Quantum of Finance",
    answer: [
      {
        item: "Salaried employees with Government Institutions, NGO’s, Schools, Corporate and reputable business houses.",
      },
      {
        item: "Professionals such as Doctors, Accountants, Lawyers etc",
      },
      {
        item: "Self employed people with proven regular income",
      },
      {
        item: "Corporate entities for purchase of company utility vehicles",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    answer: [
      {
        item: "Total loan deductions including installment on Auto Fin loan should not exceed 50% of salary net of statutory deductions.",
      },
    ],
  },
  {
