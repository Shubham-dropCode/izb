    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/BhumiFixedDepositAccount"
            element={<BhumiFixedDepositAccount />}
          />
          <Route path="/BusinessBanking" element={<BusinessBanking />} />
          <Route path="/IndoFastServe" element={<IndoFastServe />} />
          <Route
            path="/PrivilegeCurrentAcc"
            element={<PrivilegeCurrentAcc />}
          />
          <Route
            path="/ClassicCurrentAccount"
            element={<ClassicCurrentAccount />}
          />
          ...
          <Route
            path="/WorkingCapitalFinance"
            element={<WorkingCapitalFinance />}
          />
          <Route
            path="/LeaseRentalDiscounting"
            element={<LeaseRentalDiscounting />}
          />
          <Route
            path="/InternationalBankingForeignBusiness"
            element={<InternationalBankingForeignBusiness />}
          />
