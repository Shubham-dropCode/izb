        ...
        <div className="mobile-nav__wrapper">
          ...
          <div className="mobile-nav__content">
            ...
            <div className="mobile-nav__social">
              <a href="https://mobile.twitter.com/IndoZambiaBank" className="fab fa-twitter" />
              <a href="https://www.facebook.com/IndoZambiaBank?_rdc=1&_rdr#" className="fab fa-facebook-square" />
              <a href="https://www.linkedin.com/company/indo-zambia-bank/" className="fab fa-linkedin" />
              <a href="https://www.instagram.com/indo_zambia_bank/" className="fab fa-instagram" />
            </div>
          </div>
        </div>
